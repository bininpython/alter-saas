      ...
      <div className="w-full max-w-md">
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="text-right">
            <Link href="/forgot-password" className="text-sm font-black text-primary hover:underline">Esqueceu a senha?</Link>
          </div>
        ...
        <div className="mt-12 text-center space-y-8">
          <div className="relative">
            ...
            <div className="relative flex justify-center text-xs uppercase"><span className="bg-slate-50 px-4 text-slate-400 font-black tracking-widest">Ou continue com</span></div>
          </div>
          ...
          <p className="text-sm font-medium text-slate-500">
            Novo na arena? <Link href="/register" className="text-primary font-black hover:underline">Criar conta de performance</Link>
          </p>
        </div>
      </div>
    </div>
